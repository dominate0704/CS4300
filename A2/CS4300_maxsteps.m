...
% Plot 4 lines.
plot(x, max_steps_mean, x,max_steps_upperbound, x, max_steps_lowerbound, x,y);  
...
legend('y1 = mean of steps','y2 = upperbound of steps','y3 =  lowerbound of mean', 'y4 = the max steps ');
